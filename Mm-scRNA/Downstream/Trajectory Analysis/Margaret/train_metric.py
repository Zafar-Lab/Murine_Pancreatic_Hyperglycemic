...
def train_metric_learner(
    ...
    "This was done for beta and all cell population"
    
    communities = adata.obs['cluster_name']
    adata.obs['metric_clusters'] = adata.obs['cluster_name'].values
    
    clustering_scores.append(None)
